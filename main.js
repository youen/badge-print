		...
		switch (msg.$) {
			...
			case 'ToggleOrientation':
				var newOrientation = function () {
					...
					if (_v1.$ === 'Landscape') {
						return $author$project$Main$Portrait;
					} else {
						return $author$project$Main$Landscape;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'SetSize':
				...
				var newSize = function () {
					switch (str) {
						case 'Standard':
							return $author$project$Main$Standard;
						case 'Large':
							return $author$project$Main$Large;
						case 'A6':
							return $author$project$Main$A6;
						default:
							return $author$project$Main$Standard;
					}
				}();
			...
			case 'GotLogo':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Main$LogoRead,
						$elm$file$File$toUrl(file)));
			default:
				var content = msg.a;
				var updateBadgeLogo = function (b) {
				...
				var newBadges = A2($elm$core$List$map, updateBadgeLogo, model.badges);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$Main$cropMarks = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('absolute inset-0 pointer-events-none print:block hidden')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('absolute top-0 left-0 w-2 h-2 border-t border-l border-gray-400')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('absolute top-0 right-0 w-2 h-2 border-t border-r border-gray-400')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('absolute bottom-0 left-0 w-2 h-2 border-b border-l border-gray-400')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('absolute bottom-0 right-0 w-2 h-2 border-b border-r border-gray-400')
				]),
			_List_Nil)
		]));
...
var $author$project$Main$viewBadge = F2(
	function (model, badge) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('relative bg-white border border-gray-300 shadow-md flex flex-col items-center justify-center text-center overflow-hidden break-inside-avoid print:border-none print:shadow-none'),
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(badge.firstName)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('p-8 print:p-0')
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('1. Choisissez un logo')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('3. Options d\'impression')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('flex gap-4 items-center mb-4')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Taille du badge :'),
										A2(
										$elm$html$Html$select,
										_List_fromArray(
											[
												$elm$html$Html$Events$onInput($author$project$Main$SetSize),
												$elm$html$Html$Attributes$class('p-2 border rounded'),
												$elm$html$Html$Attributes$value(
												$author$project$Main$sizeToString(model.size))
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$value('A6')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('A6 (105x148mm)')
													]))
											]))
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$ToggleOrientation),
												$elm$html$Html$Attributes$class('bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
